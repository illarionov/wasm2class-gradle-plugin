...
import at.released.wasm2class.test.functional.testmatrix.compatibility.GradleVersionCompatibility.GRADLE_7_6_3
...
internal object KotlinVersionCompatibility {
    ...
    val KOTLIN_2_2_0 = Version(2, 2, 0)
    ...
    fun isKotlinCompatible(
        ...
        kotlin >= KOTLIN_2_2_0 -> gradle >= GRADLE_7_6_3 && agp >= Version(7, 3, 1)
        kotlin >= KOTLIN_2_1_0 -> gradle >= GRADLE_7_6_3 && agp >= Version(7, 3, 1)
